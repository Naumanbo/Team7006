...
@Autonomous(name="Strafe Right Parking", group="HorusHardware")
@Disabled
public class StrafeRightParking extends LinearOpMode {

    //This Autonomous Will make Horus Strafe Right and Stay in the Parking Zone
    //of the Bridge
